...
pub struct AudioState {
    ...
    pub crossfade_id: AtomicU64,
    pub crossfade_outgoing: Mutex<Option<Arc<Mutex<Option<Player>>>>>,
    pub crossfade_incoming_mix: Mutex<Option<f32>>,
...
pub fn init() -> AudioState {
    ...
    AudioState {
        ...
        crossfade_id: AtomicU64::new(0),
        crossfade_outgoing: Mutex::new(None),
        crossfade_incoming_mix: Mutex::new(None),
